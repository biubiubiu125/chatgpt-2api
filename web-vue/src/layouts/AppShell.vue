      ...
      >
        <div class="flex h-16 items-center px-5 pt-4 lg:h-20 lg:pt-5">
          <div class="flex min-w-0 items-center">
            <a
              href="https://github.com/biubiubiu125/chatgpt-2api"
              target="_blank"
            ...
            <div class="sidebar-label sidebar-brand-label">
              <p class="ui-section-title">chatgpt-2api</p>
            </div>
          </div>
        </div>
...
const defaultReleasePageUrl = 'https://github.com/biubiubiu125/chatgpt-2api/releases'
...
function applyUpdateTask(task: UpdateTaskResponse, open: boolean) {
  ...
  updateProgressState.title = task.busy ? '正在更新 chatgpt-2api' : 'chatgpt-2api 更新'
